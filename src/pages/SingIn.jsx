 ...
 toast.error(error.message, {
  ...
  const hanldePasswordReset = () => {
    ...
    forgetPassword(email)
      .then((restul) => {
        toast.success('chack your emali', {
          position: "top-right",
          autoClose: 5000,
          hideProgressBar: false,
          closeOnClick: false,
  ...
  return (
    <div className="mx-4 xl:w-5/12 lg:w-7/12 md:w-10/12 md:mx-auto bg-red-500 mt-56 backdrop-blur-[5px] border  border-white/30 rounded-2xl lg:py-[88px] py-8 lg:px-[73px] px-8">
      <Helmet><title>SignIn</title></Helmet>
      <h2 className="font-semibold lg:text-4xl pb-[50px] text-2xl  border-b border-white/30 text-center">
      ...
      >
        ...
        <p
          ...
          className="underline cursor-pointer text-yellow-500 text-base"
        >
          Forget Password
        </p>
        {
        ...
        <button
          className="cursor-pointer text-base font-semibold py-4 px-4 bg-black/20 rounded-xl border border-white/50"
          type="submit"
        >
          Login
        </button>
